...
export const bg = {
  ...
  detail: {
    ...
    biddingOpenNote: "Наддаването е отворено. Следващата оферта е показана по-долу.",
  ...
  viewings: {
    heading: "Огледи",
    lede: "Запишете се за оглед на имота. Изисква се профил.",
    empty: "Все още няма насрочени огледи за този лот.",
    openHouse: "Отворен ден",
    privateViewing: "Индивидуален оглед",
    minutes: "{n} мин",
    placesLeft: "Свободни места: {n}",
    full: "Няма свободни места",
    book: "Запиши се",
    booking: "Записване…",
    cancel: "Откажи записването",
    booked: "Записани сте",
    signInToBook: "Влезте, за да се запишете",
    errorFull: "Местата свършиха, докато записвахте.",
    errorPast: "Този оглед вече е започнал.",
    errorAlready: "Вече сте записани за този оглед.",
    errorGeneric: "Записването не бе успешно. Опитайте отново.",
  },
  bidding: {
    heading: "Наддаване",
    currentBid: "Текуща оферта",
    ...
    bidCount: { one: "{n} оферта", other: "{n} оферти" },
    nextBid: "Следваща оферта: {amount}",
    stepHint: "Наддаването е с фиксирана стъпка от {step}.",
    place: "Наддай {amount}",
    placing: "Изпращане…",
    signInToBid: "Влезте, за да наддавате",
    acceptTerms: "Приемете актуалните условия, за да наддавате",
    notApproved: "Профилът ви очаква одобрение. Ще получите известие, когато е готов.",
    needDeposit: "За този лот се изисква депозит. Свържете се с нас, за да го внесете.",
    notOpen: "Наддаването за този лот не е отворено.",
    bidderLabel: "Наддаващ {n}",
    premiumShort: "+{rate} комисиона за купувача",
    premiumOnBid: "Плюс {amount} комисиона за купувача ({rate}, с включено ДДС) — общо {total}.",
    premiumExplained: "Купувачът дължи комисиона от {rate} върху достигнатата цена, в допълнение към предложената сума. ДДС е включено в този процент.",
    history: "Последни оферти",
    extended: "удължи срока",
    errorTooFast: "Твърде много опити. Изчакайте малко и опитайте отново.",
    errorTooLow: "Някой наддаде тази сума преди вас. Следващата оферта е показана по-горе.",
    errorNotOnStep: "Офертата трябва да е точно следващата стъпка.",
    errorClosed: "Наддаването приключи.",
    errorNotApproved: "Профилът ви не е одобрен за наддаване.",
    errorTermsOutdated:
      "Общите условия са променени. Приемете новата версия, за да наддавате.",
    errorNoDeposit: "Не е регистриран депозит за този лот.",
    errorNotOpen: "Наддаването не е отворено.",
    errorGeneric: "Офертата не бе приета. Опитайте отново.",
    accepted: "Офертата ви е приета.",
    acceptedExtended: "Офертата ви е приета и удължи срока.",
  },
  termsAccept: {
    heading: "Приемете актуалните общи условия",
    intro:
      "Общите ни условия са променени, откакто ги приехте за последно. Прочетете ги и приемете новата версия, за да продължите да наддавате.",
    version: "Версия {version}",
    placeholder:
      "Тук ще се появи пълният текст на общите условия за наддаващи. Той още не е изготвен, така че тази версия е заместител и не е правен документ.",
    checkbox: "Прочетох и приемам общите условия за наддаващи.",
    submit: "Приемам и продължавам",
    errorNotTicked: "Отбележете полето, за да приемете условията.",
    signin: "Влезте в профила си, за да приемете условията.",
    accepted: "Благодарим — приемането е записано.",
    alreadyAccepted: "Вече сте приели текущата версия на общите условия.",
    continue: "Напред",
    back: "Назад",
  },
  invoice: {
    heading: "Фактура № {number}",
    issued: "Издадена на {date}",
    cancelled: "АНУЛИРАНА",
    from: "Доставчик",
    to: "Получател",
    description: "Описание",
    ...
    on: "върху {amount}",
    lot: "лот {ref}",
    print: "Отпечатване или запис като PDF",
    kind: {
      entry: "Такса за включване",
      commission: "Комисиона на продавача",
      premium: "Комисиона на купувача",
      withdrawal: "Такса за оттегляне",
    },
    specimen: "ОБРАЗЕЦ — не е валидна фактура. Данните на доставчика са примерни.",
    expiredHeading: "Връзката е изтекла",
    expiredBody:
      "Връзките към фактури са валидни 30 дни. Пишете ни и ще изпратим нова.",
  },
  footer: {
