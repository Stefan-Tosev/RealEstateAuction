...
export const en: Dictionary = {
  ...
  invoice: {
    ...
    specimen: "SPECIMEN — not a valid invoice. The issuer details are placeholders.",
    expiredHeading: "This link has expired",
    expiredBody:
      "Invoice links are valid for 30 days. Write to us and we will send a fresh one.",
  },
  footer: {
