...
export const bg = {
  ...
  bidding: {
    ...
    minimumNext: "Минимална следваща оферта: {amount}",
    minimumHint: "Това е долна граница, не стъпка — може да предложите повече.",
    yourBid: "Вашата оферта (EUR)",
    place: "Наддай",
    placing: "Изпращане…",
    ...
    errorAmount: "Въведете сума като 350000 или 350000,50.",
    errorTooLow: "Офертата е под минималната.",
